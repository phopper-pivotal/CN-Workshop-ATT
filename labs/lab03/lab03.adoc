...
. Add this https://raw.githubusercontent.com/Pivotal-Field-Engineering/CN-Workshop-ATT/master/labs/lab02/import.sql[import.sql file] found in *CN-Workshop-ATT/labs/lab02/* to +src/main/resources+. This is a rather large dataset containing all of the postal codes in the United States and its territories. This file will automatically be picked up by Hibernate and imported into the in-memory database.
...
urls: cloud-native-spring-undeliverable-iatrochemistry.cf.mycloud.com
...
[source,bash]
---------------------------------------------------------------------
$ curl -i cloud-native-spring-undeliverable-iatrochemistry.cf.mycloud.com/cities
---------------------------------------------------------------------
>>>>>>> upstream/master
